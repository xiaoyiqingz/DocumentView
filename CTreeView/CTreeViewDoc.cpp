...
// CTreeViewDoc.cpp : implementation of the CCTreeViewDoc class
//
...
void CCTreeViewDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CCTreeViewDoc::InitializeSearchContent()
{
...
void CCTreeViewDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
